...
public class ClientesDAO {
    ...
    public ClientesDAO(String nome, String endereco, String bairro, String cidade, String estado, String telefone, String celular, String cep)
    {
       this.nome = nome; 
       this.endereco = endereco;
       this.bairro = bairro;
    ...
    public boolean inserirClientes()
    {
       ...
       if(conn != null)
       {
          ...
          try
          {
             p = conn.prepareStatement("insert into clientes (Nome,Endereco,Bairro,Cidade,Estado,Telefone,Celular,CEP) values (?,?,?,?,?,?,?,?)");
